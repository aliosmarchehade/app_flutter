...
class TelaMecanica extends StatefulWidget {
  const TelaMecanica({super.key});

  @override
  State<TelaMecanica> createState() => _TelaMecanicaState();
}

class _TelaMecanicaState extends State<TelaMecanica> {
 ...
 void _adicionarItem() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Lista de Compras Mecânica')),
