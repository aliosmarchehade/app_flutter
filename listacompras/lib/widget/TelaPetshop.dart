...
class TelaPetshop extends StatefulWidget {
  const TelaPetshop({super.key});

  @override
  State<TelaPetshop> createState() => _TelaPetshopState();
}

class _TelaPetshopState extends State<TelaPetshop> {
 ...
 void _adicionarItem() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Lista de Compras items de Petshop')),
