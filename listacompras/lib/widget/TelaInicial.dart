...
class _TelaInicialState extends State<TelaInicial> with SingleTickerProviderStateMixin {
  ...
  Widget _buildListaAbas(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        _botao(context, 'Petshop', '/lista-petshop'),
        _botao(context, 'Livros', '/lista-livros'),
        _botao(context, 'Mecanica', 'lista-mecanica'),
  ...
  static final List<Map<String, dynamic>> _segments = [
    ...
    {'title': 'Livraria', 'icon': Icons.book, 'route': '/livraria'},
