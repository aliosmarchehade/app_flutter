...
class TelaEletronicos extends StatefulWidget {
  const TelaEletronicos({super.key});

  @override
  State<TelaEletronicos> createState() => _TelaEletronicosState();
}

class _TelaEletronicosState extends State<TelaEletronicos> {
 ...
 void _adicionarItem() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Lista de Compras Supermercado')),
