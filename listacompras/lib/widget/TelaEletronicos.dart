...
class TelaEletronicos extends StatelessWidget { // Pode ser StatelessWidget agora, pois a lógica está no genérico
  const TelaEletronicos({super.key});

  @override
  Widget build(BuildContext context) {
    return const ListaGenerica(
      titulo: 'Lista de Compras de Eletro-Eletronicos',
